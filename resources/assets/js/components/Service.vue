                                 ...
                                 <div class="col-md-6">
                                     <div class="input-group">
                                         <select class="form-control col-md-3" v-model="criteria">
                                           ...
                                           <option value="cs">CS consultant</option>
                                         </select>
                         ...
                         <table class="table display product-overview mb-30" id="support_table5">
                          ...
                          <tbody>
                            <tr v-for="service in arrayService" v-bind:key="service.id">
                              ...
                              <td>
                                <template v-if="service.idistatus==1">
                                  <a title="Edit" @click="openModal('service','update',service)" class="btn btn-circle btn-warning"><i class="fa fa-pencil"></i></a>
                                  <a title="Edit" @click="openModalView('service','update',service)" class="btn btn-circle btn-danger"><i class="fa fa-play-circle"></i></a>
                                </template>
                                <template v-else-if="service.idistatus==2">
                                  <a title="Edit" @click="openModalFollow('service','update',service)" class="btn btn-circle btn-primary"><i class="fa fa-search"></i></a>
                                  <a title="Edit" @click="openModal('service','updateAfter',service)" class="btn btn-circle btn-warning"><i class="fa fa-pencil"></i></a>
                                </template>
                                <template v-else="service.idistatus">
                                  <a title="Edit" @click="openModalFollow('service','update',service)" class="btn btn-circle btn-primary"><i class="fa fa-search"></i></a>
          ...
          <div class="modal-dialog modal-primary modal-lg" role="document">
              <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="button" v-if="actionType==3"class="btn btn-primary"@click="updateServiceAfter()">Update</button>
                  </div>
              </div>
              <!-- /.modal-content -->
          </div>
                  ...
                  <div class="modal-body">
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  <input type="text"  v-model="inspection_address" class="form-control"  readonly>
                              </div>
                          </div>
                          <div class="form-group row">
    ...
    export default {
        ...
        methods:{
          listService(page,search,criteria){
            let me = this;
            var url= 'service?page=' + page + '&search=' + search + '&criteria=' + criteria;
