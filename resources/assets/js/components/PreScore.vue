  ...
  <div>
    ...
    <div class="page-bar">
      <div class="page-title-breadcrumb">
          <div class=" pull-left">
              <div class="page-title">CCI Preresult</div>
          </div>
          <ol class="breadcrumb page-breadcrumb pull-right">
              <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
              </li>
              <li class="active">Completed CCI</li>
          </ol>
      </div>
    </div>
<!-- start widget -->
                 ...
                 <div class="form-group row border">
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <input class="form-control " v-model="spare_parts" readonly>
                     </div>
                   </div>
                 </div>
                 <div class="form-group row border">
                   ...
                   <div class="col-md-4">
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" v-model.number="item_cnts" readonly>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                         <label for="">Loaded cartons of spare parts</label>
                         <input type="text" class="form-control" v-model.number="sp_cnts" readonly>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                         <label for="">Total loaded cartons</label>
                         <input type="number" class="form-control" :value="calculateTotalCtns" readonly>
                       </div>
                   </div>
                 </div>
                 <div class="form-group row border">
                   ...
                   <div class="col-md-4">
                       <div class="form-group">
                         ...
                         <input type="text" v-model.number="damaged_cnts"class="form-control" readonly>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                         <label for="">Pallets were loaded Y/N?</label>
                         <input class="form-control " v-model="pallets_loadedInput" readonly>
                       </div>
                   </div>
                   <div class="col-md-4" v-if="pallets_loaded==1">
                       <div class="form-group">
                         <label for="">Pallets were fumigated Y/N?</label>
                         <input class="form-control " v-model="pallet_fumigateInput" readonly>
                       </div>
                   </div>
                 ...
                 <div class="form-group row border">
                   ...
                   <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" v-model="container_number" class="form-control" readonly>
                       </div>
                   </div>
                   <div class="col-md-6">
                       <div class="form-group">
                         <label for="">Container seal number</label>
                         <input type="text" v-model="seal_number" class="form-control" readonly>
                       </div>
                   </div>
                   <div class="col-md-6">
                     <div class="form-group">
                      <label  for="text-input">Container number photo</label>
                      <div class="widget-user-image">
                        <img  :src="getContainerPh()" alt="" style="height:300px;width:300px;">
                      </div>
                    </div>
                   </div>
                   <div class="col-md-6">
                     <div class="form-group">
                      <label  for="text-input">Container seal number photo</label>
                      <div class="widget-user-image">
                        <img  :src="getSealPh()" alt="" style="height:300px;width:300px;">
                      </div>
                    </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                         ...
                         <input class="form-control " v-model="container_damaged" readonly>
                       </div>
                   </div>
                 </div>
                 <!--<div class="form-group row border">
                 ...
                 <div class="form-group row border">
                   ...
                   <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input select class="form-control " v-model="fty_cooperateInput" readonly>
                       </div>
                   </div>
                   <div class="col-md-6">
                       <div class="form-group">
                         <label for="">Inspection Result</label>
                         <input class="form-control " v-model="result" readonly>
                       </div>
                   </div>
                   <div class="col-md-12">
                       <div class="form-group">
           ...
           <div class="card-body">
             ...
             <div class="form-group row border">
               ...
               <div class="col-md-4">
                   <div class="form-group">
                     <label for="">Inspection Result<span class="required"> * </span></label>
                     <input type="text" class="form-control" v-model.number="result" readonly>
                   </div>
               </div>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="text-input">Evidence file: </label>
                            <div class="col-md-9">
                              <input type="file"  accept="image/*" capture="camera" @change="evidenceFile" ref="myImage">
                            </div>
                          </div>
                  ...
                  <div class="modal-footer">
                    <div class="col-md-10" style="text-align:center">
                      ...
                      <button type="button"class="btn btn-primary" @click="confirmInfoCCI()"><i class="icon-like"></i>Submit Inspection Material</button>
    ...
    export default {
        ...
        methods:{
          listService(page,search,criteria){
            let me = this;
            var url= 'score/index?page=' + page + '&search=' + search + '&criteria=' + criteria;
          ...
          openDetail(data=[]){
           ...
           //AXIOS REQUEST TO GET THE ARRAY DETAIL//
            axios.get(url).then(function (response){
              ...
              self.item_cnts= parseInt(me.arrayDetail[0]['item_cnts']);
              self.sp_cnts= parseInt(me.arrayDetail[0]['sp_cnts']);
              self.total_cnts= parseInt(me.arrayDetail[0]['total_cnts']);
              ...
              if(self.pallets_loaded==1)
              {
                self.pallets_loadedInput="Yes";
              }else{
                self.pallets_loadedInput="No";
              }

              if(self.pallet_fumigate==1)
              {
                self.pallet_fumigateInput="Yes";
              }else{
                self.pallet_fumigateInput="No";
              }

              if(self.fty_cooperate==1)
              {
                self.fty_cooperateInput="Yes";
              }else{
                self.fty_cooperateInput="No";
              }
          ...
          getContainerPh(){
            return "./files/"+ this.container_numberph;
          },
          getSealPh(){
            return "./files/"+ this.seal_numberph;
          },
          confirmInfo(){
            let me=this;
          ...
          closeDetail(){
           ...
           this.pallets_loadedInput='';
           this.pallet_fumigateInput='';
