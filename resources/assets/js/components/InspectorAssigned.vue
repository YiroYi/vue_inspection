  ...
  <div>
    ...
    <div class="page-bar">
      <div class="page-title-breadcrumb">
          <div class=" pull-left">
              <div class="page-title">ARRANGED INSPECTIONS</div>
          </div>
          <ol class="breadcrumb page-breadcrumb pull-right">
              <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
              </li>
              <li class="active">Arranged Inspections</li>
          </ol>
      </div>
    </div>
<!-- start widget -->
                         ...
                         <table class="table display product-overview mb-30" id="support_table5">
                          ...
                          <tbody>
                            <tr v-for="service in arrayService" v-bind:key="service.id">
                              ...
                              <td v-text="service.total_cost"></td>
                              <td v-text="service.istatus_name"></td>
                              <td>
                                  <a class="btn btn-circle text-inverse label-warning" title="Edit" @click="openDetail(service)"><i class="fa fa-magic"></i></a>
                              </td>
                            </tr>
                          </tbody>
                         </table>
                   ...
                   <div class="form-group">
                       <label>Inspector</label>
                        <div class="form-inline">
                           <input type="text" class="form-control" value="Select inspector" readonly>
           ...
           <div class="col-md-12">
                         ...
                         <tbody v-if="arrayDetail.length">
                             <tr v-for="(detail,index) in arrayDetail" :key="detail.id">
                                 <td>
                                     ...
                                     <button @click="deleteInspector(service_id,detail.idinspector,index)" type="button" class="btn btn-danger btn-sm">
                                         <i class="icon-close"></i>
                                     </button>
                                     <button @click="editPrice(service_id,detail.idinspector,detail.detailFee)" type="button" class="btn btn-success btn-sm">
             ...
             <div class="form-group row">
                 <div class="col-md-12">
                     ...
                     <!--<button type="button" class="btn btn-success" @click="arrangeInspector()">Confirm Changes</button>-->
                 </div>
             </div>
    ...
    export default {
        ...
        computed:{
          ...
          calculateTotal: function(){
            ...
            for(var i=0;i<this.arrayDetail.length;i++){
              result=result+parseInt((this.arrayDetail[i].detailFee))
            }
            return result;
          }
        },
        methods:{
          listService(page,search,criteria){
            let me = this;
            var url= 'service/assign?page=' + page + '&search=' + search + '&criteria=' + criteria;
          ...
          validateInspector(){
            ...
            if(this.arrayDetail<=0) this.errorShowMessageArrange.push("Add at least one inspector");
          ...
          searchInspector(){
            ...
            axios.get(url).then(function (response){
              ...
              if(me.arrayInspectors.length>0)
              {
                ...
                me.inspectorType=me.arrayInspectors[0]['type'];
          ...
          findId(id){
            ...
            for(var i=0;i<this.arrayDetail.length;i++){
              ...
              if(this.arrayDetail[i].iduser==id || this.arrayDetail[i].idinspector==id ){
                sw=true;
              }
            }
            return sw;
              ...
              if(me.findId(me.idinspector)){
              ...
              }else {
                {
                  me.arrayDetail.push({
                    ...
                    inspectorType:me.inspectorType,
                    detailFee:me.fee,
                  });
                  me.name="";
                  me.idinspector=0;
          ...
          deleteInspector(ids,idu,index){
              ...
              swalWithBootstrapButtons({
                title: 'Are you sure to dismiss this inspector?',
                text: "You can assign him later!",
                type: 'warning',
                showCancelButton: true,
                ...
                if (result.value) {
                  ...
                  axios.put('assign/dismissInspector',{
                    ...
                    'iduser': idu
                      ...
                      swalWithBootstrapButtons(
                        'Desactivated!',
                        'Your inspector has been dismmisd',
                        'success'
                      )
                    })
                    .catch(function (error) {
          ...
          editPrice(ids,idu,price){
              ...
              swalWithBootstrapButtons({
                title: 'Are you sure to edit the fee for this inspectors?',
                text: "How much?",
                type: 'warning',
                showCancelButton: true,
                ...
                if (result.value) {
                  let me=this;
                  axios.put('assign/editPrice',{

                    'idservice': ids,
                    'iduser': idu,
                    'detailFee':price,
                    'total_cost':this.total.toFixed(2)
