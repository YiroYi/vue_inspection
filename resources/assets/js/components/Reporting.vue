                            ...
                            <tr v-for="service in arrayService" v-bind:key="service.id">
                              ...
                              <td>
                                <template v-if="service.action==1">
                                    <!--<a title="Edit" @click="downloadLiveReport(service.id)" class="btn btn-circle btn-info"><i class=" fa fa-download"></i></a>-->
                                    <a :href="'report/download/'+service.id" class="btn btn-circle btn-info"><i class=" fa fa-download"></i></a>
                                </template>
                                <template v-else>
                                    <a title="Edit" class="btn btn-circle btn-danger"><i class="fa fa-times"></i></a>
                                </template>
                              </td>
                            </tr>
                          </tbody>
               ...
               <!--Arrange inspector begin-->
                 <div class="form-group row">
                     <div class="col-md-12" style="text-align:center">
                         ...
                         <button type="button" @click="openModal('action',category_name)" class="btn btn-info">SUBMIT REPORT EVALUATION</button>
                     </div>
                 </div>
    ...
    export default {
        ...
        methods:{
          listService(page,search,criteria){
            let me = this;
            var url= 'report/index?page=' + page + '&search=' + search + '&criteria=' + criteria;
          ...
          validateScoreCCI(){
            ...
            if(!this.db_link) this.errorShowMessageSfaConfirm.push("Input the report link");
