  ...
  <div>
    ...
    <div class="page-bar">
      <div class="page-title-breadcrumb">
          <div class=" pull-left">
              <div class="page-title">QCI Preresult</div>
          </div>
          <ol class="breadcrumb page-breadcrumb pull-right">
              <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
              </li>
              <li class="active">Completed Qci</li>
          </ol>
      </div>
    </div>
<!-- start widget -->
                             ...
                             <div class="form-group row">
                                 <div class="col-md-6">
                                     <div class="input-group">
                                         ...
                                         <input type="text" v-model="search" @keyup.enter="listService(1,search,criteria)"class="form-control" placeholder="Searching text...">
    ...
    export default {
        ...
        methods:{
          listService(page,search,criteria){
            let me = this;
            var url= 'score/indexQci?page=' + page + '&search=' + search + '&criteria=' + criteria;
