  ...
  <div>
    ...
    <div class="page-bar">
      <div class="page-title-breadcrumb">
          <div class=" pull-left">
              <div class="page-title">INSPECTION TRACKING</div>
          </div>
                         ...
                         <table class="table display product-overview mb-30" id="support_table5">
                          ...
                          <tbody>
                            <tr v-for="service in arrayService" v-bind:key="service.id">
                              ...
                              <td v-text="service.istatus_description" width="400"></td>
                              <td>
                                <a title="Edit" @click="openModalFollow('service','update',service)" class="btn btn-circle btn-primary"><i class=" fa fa-info-circle"></i></a>
                              </td>
                            </tr>
                          </tbody>
                         </table>
                  ...
                  <div class="modal-body">
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <div class="form-group row">
                              ...
                              <label class="col-md-2 form-control-label">Ins. Date :</label>
                              <div class="col-md-4">
                                  <input type="date"  class="form-control" v-model="inspection_date" readonly>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-md-2 form-control-label" for="email-input">Sales Rep :</label>
